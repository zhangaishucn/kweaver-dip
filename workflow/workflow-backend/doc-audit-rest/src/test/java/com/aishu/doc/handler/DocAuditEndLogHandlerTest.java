...
@Transactional
public class DocAuditEndLogHandlerTest {
	...
	private final static String REALNAME_APPLY_MSG_RESULT = "文档“Anyshare://张三/文本.txt”实名共享审核完成";
	...
	private final static String ANONYMOUS_APPLY_MSG_RESULT = "文档“Anyshare://张三/文本.txt”匿名共享审核完成";
	...
	@InjectMocks
	@Autowired
	private DocAuditEndLogHandler docAuditEndLogHandler;
...
//		String result = docAuditEndLogHandler.buildMsg(args);
...
//		String result2 = docAuditEndLogHandler.buildMsg(args);
...
//		Object[] args = new Object[1];
//		args[0] = JSONUtil.toBean(REALNAME_APPLY_JSON, DocAuditHistoryModel.class);
//		String result = docAuditEndLogHandler.buildExMsg(args);
//		Assertions.assertTrue(REALNAME_APPLY_EX_MSG_RESULT.equals(result));
//		// 匿名
//		args[0] = JSONUtil.toBean(ANONYMOUS_APPLY_JSON, DocAuditHistoryModel.class);
//		String result2 = docAuditEndLogHandler.buildExMsg(args);
