  ...
  <div>
    <div class="choose-table">
      <div class="cell cell-relative">
        <el-tabs type="border-card"
          ...
          <el-tab-pane :label="$t('sync.organization')"
                       name="user"></el-tab-pane>
          <el-tab-pane :label="$t('sync.userGroup')"
                       name="userGroup"></el-tab-pane>
          ...
          <div v-if="active_name === 'userGroup'"
               v-loading="loading">
            <div class="choose-ser-1 no-border-bottom">
              <el-autocomplete clearable
                               style="width: 100%"
            ...
            <el-tree v-if="show_user_group_tree"
                     :props="default_props"
                     :element-loading-text="$t('modeler.loading')"
                     :default-expand-all="false"
                     :expand-on-click-node="false"
            ...
            <div v-else
                 class="user-group-empty-box"
                 :style="'border: 1px solid #ccc;height: ' + (treeHeight - treeHeight / 3) + 'px;padding-top: ' + (treeHeight / 3  - 20) + 'px;'">
              <div class="icon"></div>
      ...
      <div class="cell no-border">
        <div class="choose-ul">
          <div class="head">
            ...
            <div class="right">
              <el-button type="text"
                         v-if="check_user_data.length == 0 || processDisable"
          ...
          <ul :style="'height:' + chooseUlHeight + 'px;margin-top: 10px'"
              ref="chooseUl">
    ...
    <div class="foot_button"
      ...
      <el-button type="primary"
                 ...
                 style="width: 80px">{{ $t('button.confirm') }}</el-button>
      <el-button size="mini"
                 @click="closeProperties"
                 style="width: 80px">{{ $t('button.cancel') }}</el-button>
    </div>
  </div>
</template>
<script>
