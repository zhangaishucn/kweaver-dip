        ...
        <div>
          ...
          <div style="margin-top: 5px" v-loading="tableDataLoading">
            <el-table
              ...
              <el-table-column prop="auditorNames" :label="$t('strategy.table.auditor')">
              ...
              <el-table-column :label="$t('strategy.table.auditModel')" width="210">
                <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    docAuditStrategyDataRemove(_obj) {
      const _this = this
      _this.$confirm(_this.$store.state.app.secret.status === 'y' ? _this.$i18n.tc('message.secretOnceConfirmDelete') : _this.$i18n.tc('message.onceConfirmDelete'), '', {
    ...
    delStepAll(){
      let _this = this
      _this.$confirm(_this.$store.state.app.secret.status === 'y' ? _this.$i18n.tc('message.secretConfirmDelete') : _this.$i18n.tc('message.confirmDelete'), '', {
        confirmButtonText: _this.$i18n.tc('button.confirm'),
        cancelButtonText: _this.$i18n.tc('button.cancel'),
        iconClass: 'warning-blue',
        type: 'warning'
