...
public class ProcessDefinitionResourceTest {
    ...
    @Test
    @DisplayName("获取环节资源列表")
    public void findProcessDefinitionList() {
        String actDefId = "UserTask_0zz6lcw";
        List<ActivityResourceModel> resourceList = processDefinitionResource.getResource(PROCESS_DEFINITION_ID, actDefId);
