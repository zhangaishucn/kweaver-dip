    ...
    <div style="padding: 40px;font-family: Arial,sans-serif;color: #333;font-size: 14px; word-break:break-all;">
        <div style="font-weight: 700;font-size:16px;">
            <#if type == "automation">
                ...
                审核</span>
            <#else>
                <span>【${titleOem}通知】您發起的[${applyTypeName}]申請</span>
                <#if auditIdea == 'true'>
                    <span style="color: #60BC9F;">已通过</span>
                <#else>
                    <span style="color: #E60012;">未通过</span>
        ...
        <#if auditIdea != 'true' && auditMsg??>
            <p><span style="display:inline-block;">簽核意見：${auditMsg}</span></p>
        </#if>
        <#if attachments??>
            <p><span style="display:inline-block;">簽核附件：${attachments}</span></p>
        </#if>
