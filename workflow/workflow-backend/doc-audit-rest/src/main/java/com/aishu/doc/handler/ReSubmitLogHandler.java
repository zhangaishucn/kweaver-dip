...
/**
 * @description 重新发起文档审核记录日志
 * @author ouandyang
 */
@Component(value = OperationLogConstants.RESUBMIT_LOG)
public class ReSubmitLogHandler extends AbstractLogHandler implements LogHandler {
    ...
    public OperationLogDTO buildLogMsg(Object[] args) {
        ...
        log.setMsg(docAuditBizService.buildResubmitLogMsg(docAuditApplyModel));
        log.setExMsg(docAuditBizService.buildResubmitExMsg(docAuditApplyModel));
