...
@ApiModel(value = "已办列表查询参数")
@Data
public class DocAuditHistoryDTO extends BasePage {
    ...
    @ApiModelProperty(value = "审核状态，默认全部 pending表示审核中 pass表示已通过 reject表示已驳回 undone表示已撤销 donepass表示我处理的中已通过和审核中")
    @ArrayValuable(values = {
            ...
            DocConstants.AUDIT_STATUS_DONE_PASS,
            DocConstants.AUDIT_STATUS_UNDONE,
            DocConstants.AUDIT_STATUS_TRANSFER,
