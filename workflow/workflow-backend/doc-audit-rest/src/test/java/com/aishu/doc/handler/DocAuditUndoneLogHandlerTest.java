...
public class DocAuditUndoneLogHandlerTest {
	...
	private final static String ANONYMOUS_APPLY_MSG_RESULT = "文档“Anyshare://张三/文本.txt”匿名共享撤销申请";
	private final static String ANONYMOUS_APPLY_EX_MSG_RESULT = "文档路径：“Anyshare://张三/文本.txt”；共享者：“单元测试用户”；链接标题：“文本.docx”；权限：“显示/读取”；提取码：“123456”；有效期：“2021-01-01 00:00”；打开次数限制：“无限制”";

	@InjectMocks
	@Autowired
	private DocAuditUndoneLogHandler docAuditUndoneLogHandler;
...
//		args[0] = JSONUtil.toBean(REALNAME_APPLY_JSON, DocAuditHistoryModel.class);
//		String result = docAuditUndoneLogHandler.buildMsg(args);
//		Assertions.assertTrue(REALNAME_APPLY_MSG_RESULT.equals(result));
//		// 匿名
//		args[0] = JSONUtil.toBean(ANONYMOUS_APPLY_JSON, DocAuditHistoryModel.class);
//		String result2 = docAuditUndoneLogHandler.buildMsg(args);
...
//		Object[] args = new Object[1];
//		args[0] = JSONUtil.toBean(REALNAME_APPLY_JSON, DocAuditHistoryModel.class);
//		String result = docAuditUndoneLogHandler.buildExMsg(args);
//		Assertions.assertTrue(REALNAME_APPLY_EX_MSG_RESULT.equals(result));
//		// 匿名
//		args[0] = JSONUtil.toBean(ANONYMOUS_APPLY_JSON, DocAuditHistoryModel.class);
//		String result2 = docAuditUndoneLogHandler.buildExMsg(args);
