...
/**
 * @description 发起文档审核操作日志
 * @author ouandyang
 */
@DisplayName("发起文档审核操作日志")
@ActiveProfiles("ut")
@SpringBootTest(classes = DocAuditRestApplication.class)
@MockitoSettings(strictness = Strictness.LENIENT)
@Transactional
public class DocAuditApplyLogHandlerTest {
	...
	private final static String REALNAME_APPLY_MSG_RESULT = "“单元测试用户”对文档”Anyshare://张三/文本.txt“发起实名共享审核";
	...
	private final static String ANONYMOUS_APPLY_MSG_RESULT = "“单元测试用户”对文档”Anyshare://张三/文本.txt“发起匿名共享审核";
	private final static String ANONYMOUS_APPLY_EX_MSG_RESULT = "文档路径：“Anyshare://张三/文本.txt”；共享者：“单元测试用户”；SharedLink地址：“https://xxx/link/AA990D644BF12E432DB01E8E4AAB5F981D”；链接标题：“文本.docx”；权限：“显示/读取”；提取码：“123456”；有效期：“2021-01-01 00:00”；打开次数限制：“无限制”";

	@InjectMocks
	@Autowired
	private DocAuditApplyLogHandler docAuditApplyLogHandler;
...
//		String result = docAuditApplyLogHandler.buildMsg(args);
...
//		String result2 = docAuditApplyLogHandler.buildMsg(args);
...
//		Object[] args = new Object[1];
//		args[0] = JSONUtil.toBean(REALNAME_APPLY_JSON, DocAuditApplyModel.class);
//		String result = docAuditApplyLogHandler.buildExMsg(args);
//		Assertions.assertTrue(REALNAME_APPLY_EX_MSG_RESULT.equals(result));
//		// 匿名
//		args[0] = JSONUtil.toBean(ANONYMOUS_APPLY_JSON, DocAuditApplyModel.class);
//		String result2 = docAuditApplyLogHandler.buildExMsg(args);
