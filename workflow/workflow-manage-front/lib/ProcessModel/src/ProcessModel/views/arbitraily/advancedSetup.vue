<!-- 同步流程，流程高级设置页面（同流程中心一致，这里为了以后可扩展） -->
<template>
  <div class="gjsz-box">
    ...
    initrepeat_audit_rule(setup) {
      ...
      if (advancedSetup) {
        ...
        if (advancedSetup.perm_config) {
          if (
            typeof advancedSetup.perm_config.perm_switch ===
            'boolean'
          ) {
        ...
        // if (
        //   typeof advancedSetup.edit_perm_switch === 'boolean'
        // ) {
        //   _this.advancedSetup.edit_perm_switch =
        //     advancedSetup.edit_perm_switch
        // }
...
<style>
.gjsz-box .el-form-item__content::after,
.gjsz-box .el-form-item__content::before {
  display: block;
  height: 0;
}

.gjsz-box .el-form-item::after,
.gjsz-box .el-form-item::before {
  display: block;
  height: 0;
}
</style>
