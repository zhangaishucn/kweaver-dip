...
<template>
  <div name="scrollWrap" style="height: 100%;overflow: auto"  v-if="loading">
      ...
      <ul>
        <workflowPopover :ref="'popoverRef-' + item.id" placement="left-end"    width="590" :offset="100" trigger="manual" :popper-class="'view-process-popover-template view-process-popover'" :append-to-body="true" v-for="(item) in processTemplateList" :key="item.id">
