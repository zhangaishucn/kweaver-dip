 ...
 */
@Component(value = OperationLogConstants.UPDATE_DEPT_AUDITOR_RULE_LOG)
public class UpdateDeptAuditorRuleLogHandler extends AbstractLogHandler implements LogHandler {
    ...
    public String buildMsg(Object[] args) {
        Role role = (Role) args[0];
        return StrUtil.format(i18n.getMessage("editRule"), role.getRoleName());
    }
