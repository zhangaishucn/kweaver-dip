...
/**
 * @description 文档审核审核记录日志
 * @author ouandyang
 */
@Component(value = OperationLogConstants.DOC_AUDIT_END_LOG)
public class DocAuditEndLogHandler extends AbstractLogHandler implements LogHandler {
    ...
    public OperationLogDTO buildLogMsg(Object[] args) {
        ...
        log.setMsg(docAuditBizService.buildAuditedLogMsg(docAuditHistoryModel));
        log.setExMsg(docAuditBizService.buildAuditedLogExMsg(docAuditHistoryModel));
