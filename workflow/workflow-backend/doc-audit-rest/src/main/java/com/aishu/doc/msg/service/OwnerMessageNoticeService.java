...
/**
 * @description 构建实名共享（所有者）消息对象
 * @author hanj
 */
@Slf4j
@Service(value = WorkflowConstants.WORKFLOW_TYPE_SHARE + "_owner")
public class OwnerMessageNoticeService extends AbstractMessageNoticeService {
