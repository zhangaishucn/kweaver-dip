...
/**
 * @description 构建实名共享（继承变更）消息对象
 * @author hanj
 */
@Slf4j
@Service(value = WorkflowConstants.WORKFLOW_TYPE_SHARE + "_inherit")
public class InheritMessageNoticeService extends AbstractMessageNoticeService {
    @Resource
    ...
    protected List<MsgObject> buildMessageForApplicantObject(ProcessInputModel inputModel, ProcessInstanceModel result, String messageType,
        ...
        MsgContent msgContent = MsgContent.builder()
                ...
                .inherit((Boolean) fields.get("inherit"))
