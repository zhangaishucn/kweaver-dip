...
/**
 * @description 更改继承申请邮件内容
 * @author ouandyang
 */
@Service(value = "email_to_" + DocConstants.CHANGE_INHERIT)
public class InheritEmailService extends AbstractEmailService {
    /**
     * 邮件模板文件夹
     */
    ...
    protected Map<String, Object> bulidAuditorEmailFields(ProcessInstanceModel processInstance) {
        ...
        data.put("inherit", fields.get("inherit"));
    ...
    protected Map<String, Object> bulidRevocationEmailFields(ProcessInstanceModel processInstance) {
        ...
        JSONObject json = JSONUtil.parseObj(model.getApplyDetail());
        data.put("inherit", json.getBool("inherit"));
        return data;
    }
