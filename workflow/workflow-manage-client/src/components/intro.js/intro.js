    ...
    if (oldHelperLayer !== null && oldReferenceLayer !== null) {
      ...
      self._lastShowElementTimer = window.setTimeout(function () {
        ...
        if (oldHelperNumberLayer !== null) {
          oldHelperNumberLayer.innerHTML = "".concat(targetElement.step, " / ").concat(_this._introItems.length);
      ...
      if (this._options.showStepNumbers === true) {
        ...
        helperNumberLayer.innerHTML = "".concat(targetElement.step, " / ").concat(this._introItems.length);
