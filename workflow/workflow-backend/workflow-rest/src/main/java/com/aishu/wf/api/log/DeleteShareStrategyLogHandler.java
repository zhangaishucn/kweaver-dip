 ...
 */
@Component(value = OperationLogConstants.DELETE_SHARE_STRATEGY_LOG)
public class DeleteShareStrategyLogHandler extends AbstractLogHandler implements LogHandler {

    @Autowired
    DictService dictService;

    private final static String msgTemplate = "删除文档库“{}”{}审核策略";
    private final static String exMsgTemplate = "文档库 “{}”；审核员 “{}”；审核模式 “{}”";
    ...
    public String buildMsg(Object[] args) {
        ...
        if(WorkFlowContants.ANONYMITY_SHARE_PROC_DEF_KEY.equals(procDefKey)){
            return StrUtil.format(i18n.getMessage("deleteDocumentLibrary")+"”{}“{}"+i18n.getMessage("approvalPolicy"), shareStrategy.getDocName(), i18n.getMessage("shareWithAnyone"));

        }
        return StrUtil.format(i18n.getMessage("deleteDocumentLibrary")+"”{}“{}"+i18n.getMessage("approvalPolicy"),
