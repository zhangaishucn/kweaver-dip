<template>
  <el-dialog :title="dialog_title" :close-on-click-modal="false" top="35px" :visible="visible" :append-to-body="true" @close="cancel">
    <div class="choose-table">
      <div class="cell cell-relative">
        ...
        <div v-loading="loading" class="choose-ul">
          ...
          >
            <span slot-scope="{ node, data }" class="custom-tree-node" :class="node.label === checkDataName ? 'disable' : ''">
      ...
      <div class="cell no-border">
        <div class="choose-ul">
          ...
          <ul style="height: 450px">
            ...
            <li v-for="(item, index) in check_data" :key="index">
              <span>
    ...
    <div slot="footer" class="dialog-footer">
      <div>
        <el-button type="primary" style="min-width: 80px" size="small" @click="confirm">{{ $t('button.confirm') }}</el-button>
