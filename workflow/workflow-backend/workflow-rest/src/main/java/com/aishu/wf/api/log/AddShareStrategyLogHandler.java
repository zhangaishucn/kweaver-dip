 ...
 */
@Component(value = OperationLogConstants.ADD_SHARE_STRATEGY_LOG)
public class AddShareStrategyLogHandler extends AbstractLogHandler implements LogHandler {
    ...
    public String buildMsg(Object[] args) {
        ...
        if(WorkFlowContants.ANONYMITY_SHARE_PROC_DEF_KEY.equals(procDefKey)){
            return StrUtil.format(i18n.getMessage("createDocumentLibrary")+"”{}“{}"+i18n.getMessage("approvalPolicy"), shareStrategy.getDocName(), i18n.getMessage("shareWithAnyone"));
        }
        return StrUtil.format(i18n.getMessage("createDocumentLibrary")+"”{}“{}"+i18n.getMessage("approvalPolicy"),
