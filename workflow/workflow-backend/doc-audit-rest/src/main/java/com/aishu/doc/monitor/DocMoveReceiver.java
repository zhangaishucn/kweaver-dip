...
/**
 * @description 文件移动消息监听类
 * 文档移动作废流程屏蔽，只需监听取消申请nsq作废流程
 * @author Liuchu
 */
@Slf4j
// @Component(value = NsqConstants.CORE_FILE_MOVE)
public class DocMoveReceiver implements MessageHandler {
	...
	public void handler(String msg) {
		...
		try {
			...
			log.warn("文件移动消息监听类处理失败！msg：{}", msg, e);
			throw e;
		} finally {
		}
	}
