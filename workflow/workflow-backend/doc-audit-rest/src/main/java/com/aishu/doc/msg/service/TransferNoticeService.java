 ...
 **/
@Slf4j
@Service(value = WorkflowConstants.WORKFLOW_TYPE_TRANSFER)
public class TransferNoticeService extends AbstractMessageNoticeService  {
    ...
    protected List<MsgObject> buildMessageForAuditorObject(ProcessInputModel inputModel, ProcessInstanceModel result, String messageType,
        ...
        MsgContent msgContent = MsgContent.builder()
                ...
                .type(ProcessMsgTypeEnum.getValueByName("transfer_open"))
